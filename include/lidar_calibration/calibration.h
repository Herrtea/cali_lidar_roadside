...
private:
    ...
    string neh_txt = "/home/guoz/calibration_ws/src/lidar_calibration/data/neh.txt";     // 待读取的东北天(全局)坐标系下点的坐标
    string lidar_txt = "/home/guoz/calibration_ws/src/lidar_calibration/data/lidar.txt"; // 待读取的雷达坐标系下点的坐标
